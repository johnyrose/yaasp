...
from yaasp.actions.generate_full_stock_report import generate_full_stock_report
...
from yaasp.config import MAX_REPORT_FETCHING_THREADS
from yaasp.export.export_reports import export_stock_report
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=MAX_REPORT_FETCHING_THREADS) as executor:
        ...
        for result in results:
            try:
                ...
                console.print(f"Error exporting stock report for symbol: {result}, error: {e}")
